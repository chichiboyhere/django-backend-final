...
import questions from './QuantitativeQuestionsThree'
import GetSolutionThree from "./GetSolutionThree";
...
// More on Mathjax typing: https://github.com/mathjax/MathJax/issues/2510 

const QuantitativeTestThree = ({history}) => {
        ...
        {showTime && (
          <>
            <div className={classes.stopwatch}>
              <Timer time={time} />
              <Text text={'Quantitative Test Three'}/>
              <ControlButtons
                active={isActive}
                isPaused={isPaused} 
...
export default QuantitativeTestThree