...
import questions from "./VerbalQuestionsOne";
...
const VerbalTestOne = ({history}) => {
   ...
   // Clear the flashed message
  //  useEffect(() => {
  //   setTimeout(() => setFlashedMsg(false), 6000)
  //    }, []);
